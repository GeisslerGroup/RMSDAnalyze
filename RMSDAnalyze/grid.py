...
class RadialCoords:
    ...
    def GetMtxScale(gridsize):
        return max(gridsize[0] / r_extent, gridsize[1] / (2 * z_extent)) * 100
...
def GridOPRadial(data_tik, display_type=[], dynamic_step = 0, colorrange=[None,None], op_type='density', \
    ...
    (data, data_pos), (density,density_pos) = coord_system.ProcessSparseRunner(running_mean_mtx, running_weight_mtx, mtx_scale, z_extent)
